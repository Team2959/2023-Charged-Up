...
public class PlacementArmSubsystem extends SubsystemBase {
    ...
    public PlacementArmSubsystem() {
        ...
        // m_armRotatorMotorPidController.setSmartMotionMaxVelocity(kArmRotatorSmartMotionMaxVelocity,
        // 0);
        // m_armRotatorMotorPidController.setSmartMotionMaxAccel(kArmRotatorSmartMotionMaxAcceleration,
        // 0);
        ...
        // m_armExtensionMotorPidController.setSmartMotionMaxVelocity(kArmExtensionSmartMotionMaxVelocity,
        // 0);
        // m_armExtensionMotorPidController.setSmartMotionMaxAccel(kArmExtensionSmartMotionMaxAcceleration,
        // 0);
        smartDashboardInit();
    }
    ...
    public void smartDashboardInit() {
        ...
        // SmartDashboard.putNumber(getName() + "/Arm Rotator IZone",
        // m_armExtensionMotorPidController.getIZone());
        // SmartDashboard.putNumber(getName() + "/Arm Extension FF",
        // m_armExtensionMotorPidController.getFF());
        // SmartDashboard.putNumber(getName() + "/Arm Rotator Smart Motion Max
        // Velocity", m_armExtensionMotorPidController.getSmartMotionMaxVelocity(0));
        // SmartDashboard.putNumber(getName() + "/Arm Rotator Smart Motion
        // Acceleration", m_armExtensionMotorPidController.getSmartMotionMaxAccel(0));
        ...
        // SmartDashboard.putNumber(getName() + "/Arm Extension IZone",
        // m_armExtensionMotorPidController.getIZone());
        // SmartDashboard.putNumber(getName() + "/Arm Extension FF",
        // m_armExtensionMotorPidController.getFF());
        // SmartDashboard.putNumber(getName() + "/Arm Extension Smart Motion Max
        // Velocity", m_armExtensionMotorPidController.getSmartMotionMaxVelocity(0));
        // SmartDashboard.putNumber(getName() + "/Arm Extension Smart Motion
        // Acceleration", m_armExtensionMotorPidController.getSmartMotionMaxAccel(0));
    ...
    public void smartDashboardUpdate() {
        ...
        // m_armRotatorMotorPidController.setIZone (SmartDashboard.getNumber(getName() +
        // "/Arm Rotator IZone", kArmRotatorIZone));
        // m_armRotatorMotorPidController.setFF (SmartDashboard.getNumber(getName() +
        // "/Arm Rotator FF", kArmRotatorFF));
        // m_armRotatorMotorPidController.setSmartMotionMaxVelocity(SmartDashboard.getNumber(getName()
        // + "/Arm Rotator Smart Motion Velocity", kArmRotatorSmartMotionMaxVelocity),
        // 0);
        // m_armRotatorMotorPidController.setSmartMotionMaxAccel(SmartDashboard.getNumber(getName()
        // + "/Arm Rotator Smart Motion Acceleration",
        // kArmRotatorSmartMotionMaxAcceleration), 0);
        ...
        // m_armExtensionMotorPidController.setIZone (SmartDashboard.getNumber(getName()
        // + "/Arm Extension IZone", kArmExtensionIZone));
        // m_armExtensionMotorPidController.setFF (SmartDashboard.getNumber(getName() +
        // "/Arm Extension FF", kArmExtensionFF));
        // m_armExtensionMotorPidController.setSmartMotionMaxVelocity(SmartDashboard.getNumber(getName()
        // + "/Arm Extension Smart Motion Velocity", kArmRotatorSmartMotionMaxVelocity),
        // 0);
        // m_armExtensionMotorPidController.setSmartMotionMaxAccel(SmartDashboard.getNumber(getName()
        // + "/Arm Extension Smart Motion Acceleration",
        // kArmRotatorSmartMotionMaxAcceleration), 0);
    }

    public void setArmDegrees(double degrees) {

        // m_armRotatorMotorPidController.setReference(degrees,
    ...
    public void setArmRotatorPosition(double angle) {
        m_armRotatorMotorPidController.setSetpoint(angle);
    }
